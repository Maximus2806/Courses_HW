...
const checkAge_withtype = function(age){
...
checkAge_withtype("18");


// 3**:
// Преобразовать 2* таким образом, чтобы значение '2' (строка в которой лежит ТОЛЬКО ЦИФРА) пропускалось, преобразовываясь в number
console.log("------------")
const checkAge_withtypeAndNuminStr = function(age){
    if (isNaN(age) || typeof(age) == "boolean" || typeof(age) == "object") {
        console.log("Age is not a number but", typeof(age))
    } else {
        if (age < 18) {
            console.log("You don't have access cause your age is ", age, " It's less then 18")
...
checkAge_withtypeAndNuminStr("18");

// 4***:
// Преобразовать задание 3* таким образом, чтобы возраст вводится используя функцию prompt в привязанной верстке
// console.log("----------------")

// let yourAge = prompt("Input your age: ", 100);
